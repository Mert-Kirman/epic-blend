...
public class PlayList {
    ...
    public int heartacheOfferedCount;  // Amount of Heartache songs offered to the EpicBland from this playlist
    public int roadTripOfferedCount;  // Amount of Road Trip songs offered to the EpicBland from this playlist
    public int blissfulOfferedCount;  // Amount of Blissful songs offered to the EpicBland from this playlist
